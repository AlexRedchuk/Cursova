...
<div class="form">
    ...
    <span>Edition:</span> <@spring.formSingleSelect "editionOrderLogForm.edition", editionsL, ""/>
    <span>Order: </span><@spring.formSingleSelect "editionOrderLogForm.order", ordersL, ""/>
