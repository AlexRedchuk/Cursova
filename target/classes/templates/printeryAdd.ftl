...
<div class="form">
    ...
    <span>Name:</span><@spring.formInput "printeryForm.name" "" "text"/>
    <span>Address:</span><@spring.formInput "printeryForm.address", "", "text"/>
    <span>Phone number:</span><@spring.formInput "printeryForm.phoneNumber", "", "text"/>
